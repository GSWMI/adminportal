...
import { LayoutDashboard, Ticket, CreditCard, Users, HandCoins, Settings, ChevronUp, LogOut } from 'lucide-react'
...
const navItems = [
  ...
  { label: 'Contributions', icon: HandCoins, to: '/contributions' },
